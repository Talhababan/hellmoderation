...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
   ...
   message.channel.send(new MessageEmbed().setColor('BLACK').setDescription(`${kullanıcı} <a:gvenli:817747565369491456> Başarıyla Afk Oldunuz Afk Olmanızın Sebebi: **${ramo}**`));
