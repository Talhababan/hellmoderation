...
if(!["817286351246458912","817286351312650247"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
let guild = "817286351011053609"; // SUNUCU ID
...
return {
'0': `<a:0_:817752623355920384>`,
'1': `<a:1_:817752630444294184>`,
'2': `<a:2_:817752641127055362>`,
'3': `<a:3_:817752642260041728>`,
'4': `<a:4_:817752641177124885>`,                       
'5': `<a:5_:817752639642796082>`,
'6': `<a:6_:817752641559855156>`,
'7': `<a:7_:817752641416593409>`,
'8': `<a:8_:817752641752006687>`,
'9': `<a:9_:817752641962508328>`}[d];})}
...
var booster = message.guild.roles.cache.get("817314877190176790").members.size
...
.setAuthor(message.guild.name, message.guild.iconURL({ dynamic: true }))
 .setDescription(`
<a:hellhac:817320940856672276> **Sunucuda Toplam** ${üyesayısı} **Üye bulunmakta.** 
<a:hellhac:817320940856672276> **Sunucuda Toplam** ${cevirimici} **Üye Çevrimiçi.** 
<a:hellhac:817320940856672276> **Ses Kanallarında** ${sessayı} **Üye Sohbet Ediyor.**
<a:hellhac:817320940856672276> **Tagımızda Toplam ** ${taglılar} **Üye Bulunmakta.**
<a:hellhac:817320940856672276> **Sunucuda Toplam ${booster} Booster Üye Bulunmakta.**`)
